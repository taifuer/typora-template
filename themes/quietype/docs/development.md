...
在主题目录（仓库中的 `themes/quietype/` 或解压后的主题包目录）运行以下命令重新生成预览，需要 Pandoc、Chromium/Chrome，以及本机 Typora 的 `resources` 目录：
...
本版通过 CSS `@import` 继承内置 GitHub 样式，主题接口与文件命名参考 [Typora 主题开发文档](https://theme.typora.io/doc/Write-Custom-Theme/)。
