...
下载 [Word 模板包](https://github.com/taifuer/typora-template/releases/download/v0.2.0/typora-word-0.2.0.zip)，或单独下载 [standard.docx](https://github.com/taifuer/typora-template/releases/latest/download/standard.docx)、[tech.docx](https://github.com/taifuer/typora-template/releases/latest/download/tech.docx)。包内模板位于 `templates/`。
